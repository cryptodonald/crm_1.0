...
export function LeadsDataTable({
  ...
  // Funzioni per rendering badge provenienza
  ...
  const renderProvenienzaOption = (option: Option, isSelected: boolean) => (
    <div className="flex items-center w-full">
      <Badge 
        variant="secondary" 
        className={`text-xs mr-2 ${getProvenenzaBadgeColor(option.value as LeadProvenienza)}`}
      >
        {option.label}
      </Badge>
    </div>
  ...
  const renderProvenienzaSelectedBadge = (option: Option) => (
    <Badge 
      variant="secondary" 
      className={`text-xs rounded-sm px-1 font-normal ${getProvenenzaBadgeColor(option.value as LeadProvenienza)}`}
    >
      {option.label}
    </Badge>
  );
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
            ...
            {/* Filtro Provenienza con componente persistente e badge colorati */}
            <DataTablePersistentFilter
              title="Provenienza"
              ...
              renderOption={renderProvenienzaOption}
              renderSelectedBadge={renderProvenienzaSelectedBadge}
            />
          </div>
