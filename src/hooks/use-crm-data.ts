...
export function useLeads(params?: {
  ...
  const { data, error, isLoading } = useSWR<ApiResponse<PaginatedResponse<Lead>>>(
    url,
    fetcher
  );

  const create = useCallback(async (input: LeadInput): Promise<Lead> => {
  ...
  const update = useCallback(async (id: string, input: Partial<LeadInput>): Promise<Lead> => {
...
export function useActivities(params?: {
  ...
  const { data, error, isLoading } = useSWR<ApiResponse<PaginatedResponse<Activity>>>(
    url,
    fetcher
  );

  const create = useCallback(async (input: ActivityInput): Promise<Activity> => {
  ...
  const update = useCallback(async (id: string, input: Partial<ActivityInput>): Promise<Activity> => {
...
export function useContacts(params?: {
  ...
  const { data, error, isLoading } = useSWR<ApiResponse<PaginatedResponse<Contact>>>(
    url,
    fetcher
  );
  ...
  const update = useCallback(async (id: string, input: Partial<ContactInput>): Promise<Contact> => {
