...
export default function AutomationsPage() {
  ...
  useEffect(() => {
    if (!authLoading && user && !isAdmin) {
      console.log('🚫 [AutomationsPage] Non-admin user attempting access, redirecting to dashboard');
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Solo gli amministratori possono accedere alle automazioni.
            </p>
  ...
  return (
    <AppLayoutCustom>
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        <PageBreadcrumb pageName="Automazioni" />

        <div className="px-4 lg:px-6">
          <div className="flex flex-col gap-6">
            {/* Page content will be implemented here */}
            <div className="container mx-auto px-4 py-8 text-center">
              <h1 className="mb-4 text-2xl font-bold">Automazioni Workflow</h1>
