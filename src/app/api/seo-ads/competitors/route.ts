...
import { getCompetitorInsights } from '@/lib/seo-ads/queries';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filters = {
      ...
      competitor_domain: searchParams.get('competitor_domain') || undefined,
    ...
    const result = await getCompetitorInsights(filters);
    ...
    console.error('[API] GET /api/seo-ads/competitors error:', error);
    return NextResponse.json(
