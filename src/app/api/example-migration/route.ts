...
import { getAirtableKey, getWhatsAppKeys, getGitHubToken } from '@/lib/api-keys-service';
      ...
      retrievedKeys: {
        ...
        whatsapp: {
          accessToken: {
            ...
            preview: whatsappKeys.accessToken ? `${whatsappKeys.accessToken.slice(0, 12)}...` : null,
            source: 'KV Database'
          },
          webhookSecret: {
    ...
    return NextResponse.json(
      {
        ...
        fallback: 'In production, implement fallback mechanisms for critical services'
      },
      { status: 500 }
    );
  }
